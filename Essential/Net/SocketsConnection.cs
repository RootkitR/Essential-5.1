...
namespace Essential.Net
{
    public sealed class SocketConnection : Socket, IDisposable
    {
            ...
            : base(socketInformation_0)
        {
            ...
            this.string_1 = base.RemoteEndPoint.ToString();
        }
        ...
        internal void SendData(byte[] byte_1)
        {
            ...
            if (!this.bool_0)
            {
                ...
                {
                    Essential.GetGame().GetClientManager().DisposeConnection(this);
                }
            }
        }
        ...
        public void SendMessage(string string_1)
        {
            ...
            this.SendData(Essential.GetDefaultEncoding().GetBytes(string_1));
        }
